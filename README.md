...
I'm a beginner developer with focus on Java and Spring Boot, passionate about building and understanding both, hardware and software that makes people’s lives easier.
...
## Featured Projects
1. **SpaceControl**: Space Controll is a comprehensive office space management system that enables efficient allocation and utilization of office resources.
### 🛠️ Tech Stack
🔹 **Backend:** Java, Spring Boot, MySQL  
🔹 **Frontend:** JavaScript, Tailwind, Thymeleaf, HTML, CSS

[View Repository](https://github.com/DKgmpl/SpaceControll)
  
3. **Meeting Location Jade**: An e-commerce platform that allows users to browse and purchase products seamlessly.
